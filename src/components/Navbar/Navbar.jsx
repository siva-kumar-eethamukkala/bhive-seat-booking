...
import Logo from "../../assets/Images/BhiveLogo.svg";

const Navbar = () => {
  return (
    <nav className="sticky top-0 z-[9999] bg-white w-full h-[90px] px-5 sm:px-18 lg:px-30 flex justify-between">
      <div className="flex shrink-0 items-center">
        <img className="w-[125px] h-[40px]" src={Logo} alt="Your Company" />
      </div>
      <div className="flex items-center">
        <button
          type="button"
          className="w-[42px] h-[42px] flex items-center justify-center relative border rounded-[4px] border-[#FFBB00] shadow-[4px_4px_14px_0px_#0000000F]"
        >
